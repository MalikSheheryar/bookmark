        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-center ">
              {/* Actual Score Circle */}
              <div className="relative w-[225px] h-[225px] flex-shrink-0">
                <svg
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  <div className="text-[20px] font-normal text-[#020202]">
                    73 out of 77
                  </div>
                  <div className="text-[80px] font-normal text-[#20589A] leading-none">
                    176
                  </div>
                  <div className="text-[14px] font-normal text-[#20589A] mt-1">
                    99.6 percentile
                  </div>
                </div>
              </div>
              ...
              {/* Section LR */}
              <div
                className="relative w-[195px] h-[195px] flex-shrink-0"
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center leading-none">
                  <div className="text-[24px] font-normal text-[#020202] mb-[2px] relative">
                    LR
                    <span className="absolute -top-1 -right-4 text-[28px] text-[#0866FF]">
                      *
                    </span>
                  </div>
                  <div className="text-[64px] font-normal text-[#020202]">
